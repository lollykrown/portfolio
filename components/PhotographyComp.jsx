...
// ─── Main page ────────────────────────────────────────────────────
export default function PhotographyComp() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-(--color-bg-page) pt-20">
      ...
      <section className="relative min-h-[80vh] flex items-end px-6 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, #0a0a12 0%, #12100e 50%, #0a0c0a 100%)',
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to right, rgba(10,10,18,1) 40%, rgba(10,10,18,0.6) 10%, rgba(10,10,18,0.1) 10%)',
            }}
          />
          {/* Bottom fade */}
          <div
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            >
              Documentary, editorial, and portrait photography that tells your
              story with honesty and artistry.
            </motion.p>
                    ...
                    >
                      <div className="flex justify-end">
                        ...
                        >
                          ...
                          >
                            <path
                              d="M2 2h4M2 2v4M12 2h-4M12 2v4M2 12h4M2 12v-4M12 12h-4M12 12v-4"
                              stroke="white"
                              strokeWidth="1.2"
                              strokeLinecap="round"
                            />
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          >
                            <path
                              d="M5 1C3.343 1 2 2.343 2 4c0 2.5 3 5 3 5s3-2.5 3-5c0-1.657-1.343-3-3-3zm0 4a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"
      ...
      >
        ...
        rgba(255,255,255,0.4) 2px, rgba(255,255,255,0.4) 3px
              ...
              <div
                ...
                style={{
                  background:
                    'radial-gradient(ellipse at 50% 50%, color-mix(in srgb, var(--color-accent-muted) 12%, transparent) 0%, transparent 70%)',
                }}
              />
            ...
            >
              <Image
                ...
                alt="Photographer at work — behind the lens"
              />
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-4xl md:text-5xl font-black leading-[0.95] mb-6"
              style={{ color: 'var(--color-text-primary)' }}
            >
              Light, story,
              <br />
            ...
            <motion.p
              ...
              style={{ color: 'var(--color-text-secondary)' }}
            >
              I believe every photograph is a collaboration between the subject
              and the light. My job is simply to be ready when that moment
              arrives — and patient enough to wait for it.
            </motion.p>
            <motion.p
              variants={fadeUp}
              ...
              style={{ color: 'var(--color-text-muted)' }}
            >
              With over 4 years shooting across 40+ locations — from intimate
              portrait sessions to big events — I bring the same intentionality
            ...
            >
              {[
                {
                  title: 'Documentary instinct',
                  desc: 'Real moments over posed perfection, always.',
                },
                {
                  title: 'Obsessive with light',
                  desc: 'Golden hour, studio, overcast — every light has a mood.',
                },
                {
                  title: 'Minimal footprint',
                  desc: 'Small kit, less disruption, more authentic images.',
                },
              ].map((p) => (
                <motion.div
                  key={p.title}
              ...
              {[
                {
                  icon: '👤',
                  category: 'Portraits',
                  desc: 'Individual, couple, and family sessions. Studio or location. Relaxed, natural, and always you.',
                  price: 'From £150',
                  tag: null,
                },
                {
                  icon: '💍',
                  category: 'Weddings',
                  desc: 'Full-day documentary coverage from prep to dance floor. No missed moments, no forced smiles.',
                  price: 'On request',
                  tag: 'Most booked',
                },
                {
                  ...
                  desc: 'Photography for birthdays, anniversaries, and other special life events. Capturing joy and celebration.',
                  price: 'From £250',
                  tag: null,
                },
                {
                  ...
                  desc: 'Capturing the beauty and emotion of Maternity, newborns, and family milestones.',
                  price: 'From £150',
                  tag: null,
                },
                {
                  icon: '✈️',
                  category: 'Travel',
                  desc: 'Destination shoots, travel editorial, and commercial location photography worldwide.',
                  price: 'On request',
                  tag: null,
                },
                {
                  icon: '📸',
                  category: 'Commercial',
                  desc: 'Brand, product, and lifestyle photography. Clean, compelling images that sell.',
                  price: 'From £200',
                  tag: null,
                },
                {
                  icon: '📅',
                  category: 'Others',
                  desc: 'Specialized photography services for unique projects and creative endeavors.',
                  price: 'On request',
                  tag: null,
                },
      ...
      {/* ── TESTIMONIALS ──────────────────────────────────────────── */}
      <TestimonialsCarousel stagger={stagger} fadeUp={fadeUp} />
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-5xl md:text-7xl font-black leading-[0.92] mb-8"
              style={{ color: 'var(--color-text-primary)' }}
            >
              Your story
              <br />
            ...
            <motion.p
              variants={fadeUp}
              className="text-lg leading-relaxed mb-12 max-w-md mx-auto"
              style={{ color: 'var(--color-text-secondary)' }}
            >
              Whether it&apos;s a wedding, editorial shoot, or something
              entirely different — I&apos;d love to hear about it.
            </motion.p>
            <motion.div
              variants={fadeUp}
            ...
            >
              <Link
                href="https://wa.me/+447425932661"
                className="btn-accent px-9 py-4 rounded-full text-base inline-flex items-center gap-2"
              >
                Book a session
