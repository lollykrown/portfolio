  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
        ...
        <path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72m2.54-15.38c-3.72 4.35-8.94 5.66-16.88 5.85m19.5 1.9c-3.5-.93-6.63-.82-8.94 0-2.58.92-5.01 2.86-7.44 6.32" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      </svg>
    ),
  },
];
    ...
    <footer
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          style={{
            backgroundColor: "color-mix(in srgb, var(--color-accent-muted) 18%, var(--color-bg-card-darker))",
        ...
        >
          ...
          <div
            className="absolute inset-0 pointer-events-none"
            style={{ background: "radial-gradient(ellipse at top left, color-mix(in srgb, var(--color-accent) 10%, transparent), transparent 65%)" }}
          />
          {/* Top shimmer line */}
          <div
          ...
          <div className="relative z-10 text-center md:text-left">
            <p className="text-xs font-semibold tracking-[0.2em] uppercase mb-2" style={{ color: "var(--color-accent-subtle)" }}>
              Available for work
            </p>
            <h3 className="text-2xl md:text-3xl font-black leading-tight" style={{ color: "var(--color-text-primary)" }}>
              Got a project in mind?
              <br />
              <span className="text-accent-gradient">Let&apos;s make it happen.</span>
            </h3>
          </div>
        ...
        {/* ── Main footer grid ────────────────────────────────────── */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 pb-14 border-b" style={{ borderColor: "var(--color-border)" }}>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mt-2 mb-6" style={{ color: "var(--color-text-secondary)" }}>
              Freelance web developer crafting fast, beautiful, and purposeful digital products — pixel by pixel.
            </p>
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-4" style={{ color: "var(--color-text-secondary)" }}>
              Tips on web dev, design, and freelancing — straight to your inbox. No spam.
            </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-7">
          ...
          <div className="flex items-center gap-4">
            <Link href="/privacy" className="text-xs transition-colors" style={{ color: "var(--color-text-muted)" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "var(--color-text-primary)")}
              onMouseLeave={(e) => (e.currentTarget.style.color = "var(--color-text-muted)")}
            >
              Privacy
            </Link>
            <Link href="/terms" className="text-xs transition-colors" style={{ color: "var(--color-text-muted)" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "var(--color-text-primary)")}
              onMouseLeave={(e) => (e.currentTarget.style.color = "var(--color-text-muted)")}
            >
              Terms
