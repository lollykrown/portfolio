  ...
  return (
    <main className="min-h-screen flex flex-col bg-(--color-bg-page) pt-20">
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        <span
          className="absolute left-[5%] top-[30%] text-[120px] font-black select-none leading-none hidden lg:block"
          style={{
            color:
        ...
        <span
          className="absolute right-[5%] bottom-[20%] text-[120px] font-black select-none leading-none hidden lg:block"
          style={{
            color:
              'color-mix(in srgb, var(--color-text-primary) 3%, transparent)',
          }}
        ...
        >
          ...
          <motion.h1
            variants={fadeUp}
            className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.95] tracking-tight mb-7"
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                >
                  ...
                  <div
                    className="rounded-2xl p-6 border h-full hover:border-white/20 transition-colors duration-300"
                    style={{
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ color: 'var(--color-text-secondary)' }}
            >
              I'm open to freelance work and collaborations. Let's turn your
