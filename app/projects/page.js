  ...
  return (
    <main className="min-h-screen flex flex-col bg-(--color-bg-page) pt-20">
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        <span className="absolute left-[5%] top-[30%] text-[120px] font-black select-none leading-none hidden lg:block"
          style={{ color: 'color-mix(in srgb, var(--color-text-primary) 3%, transparent)' }}>01</span>
        <span className="absolute right-[5%] bottom-[20%] text-[120px] font-black select-none leading-none hidden lg:block"
          style={{ color: 'color-mix(in srgb, var(--color-text-primary) 3%, transparent)' }}>—</span>

        <motion.div className="relative z-10 text-center max-w-5xl mx-auto" variants={stagger} initial="hidden" animate="show">
          <motion.span variants={fadeUp} className="inline-block text-xs font-semibold tracking-[0.25em] uppercase mb-5"
            style={{ color: 'var(--color-accent-subtle)' }}>Portfolio</motion.span>
          <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.95] tracking-tight mb-7"
            style={{ color: 'var(--color-text-primary)' }}>
            Work that<br />
            <span className="text-accent-gradient">moves</span> the needle
          </motion.h1>
          <motion.p variants={fadeUp} className="text-lg max-w-lg mx-auto leading-relaxed mb-10"
          ...
          <motion.div variants={fadeUp} className="flex items-center justify-center gap-4 flex-wrap">
            ...
            <Link href="/contact"
              className="text-sm font-semibold px-7 py-3 rounded-full border transition-all duration-200"
            ...
            <motion.div variants={fadeUp} className="flex items-end justify-between flex-wrap gap-4 mb-8">
              <div>
                <span className="text-xs font-semibold tracking-[0.2em] uppercase block mb-3"
                  style={{ color: 'var(--color-accent-subtle)' }}>Selected Work</span>
            ...
            <div className="mt-14 flex flex-col items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  disabled={page === 1}
                  className="w-9 h-9 rounded-full border flex items-center justify-center transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed"
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <motion.span variants={fadeUp} className="inline-block text-xs font-bold tracking-[0.2em] uppercase mb-4"
              style={{ color: 'var(--color-accent-subtle)' }}>How I work</motion.span>
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-black mb-14"
              style={{ color: 'var(--color-text-primary)' }}>
              ...
              {[
                ...
                <motion.div key={item.step} variants={cardVar} className="relative group">
                  ...
                  <div className="rounded-2xl p-6 border h-full hover:border-white/20 transition-colors duration-300"
                    ...
                    <span className="text-4xl font-black block mb-4 leading-none"
                      style={{ color: 'color-mix(in srgb, var(--color-accent) 50%, transparent)' }}>{item.step}</span>
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <span className="inline-block text-xs font-bold tracking-[0.2em] uppercase mb-4"
            style={{ color: 'var(--color-accent-subtle)' }}>Tech stack</span>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['HTML/CSS','Javascript','Node.js','React','React Native','Next.js','TypeScript','Tailwind CSS','Framer Motion','Prisma','Vercel','Figma','Digital Ocean','Git','GitHub','CI/CD','Agile methodologies','Test-driven development','RESTful APIs','GraphQL','SEO','Firebase','Stripe','Headless CMS','Microservices','WebSockets','OAuth','JWT'].map((tech) => (
              <span key={tech}
                className="text-sm font-medium px-5 py-2.5 rounded-full border transition-all duration-200 cursor-default"
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <motion.span variants={fadeUp} className="inline-block text-xs font-bold tracking-[0.2em] uppercase mb-5"
              style={{ color: 'var(--color-accent-subtle)' }}>Let's build together</motion.span>
            ...
            <motion.p variants={fadeUp} className="text-lg leading-relaxed mb-10 max-w-md mx-auto"
              style={{ color: 'var(--color-text-secondary)' }}>
