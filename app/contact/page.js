...
const contactInfo = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
        <path d="M10 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" stroke="currentColor" strokeWidth="1.5"/>
      ...
      <div className="flex items-center justify-between py-5 gap-4">
        ...
        >
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
            <path d="M6 2v8M2 6h8" stroke={open ? "var(--color-accent)" : "white"} strokeWidth="1.5" strokeLinecap="round"/>
          </svg>
        </span>
      </div>
      <motion.div
    ...
    >
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <Glow style={{ width: 600, height: 350, top: "10%", left: "15%", backgroundColor: "color-mix(in srgb, var(--color-accent-muted) 14%, transparent)" }} />
          <Glow style={{ width: 400, height: 300, bottom: 0, right: "10%", backgroundColor: "color-mix(in srgb, var(--color-accent-muted) 8%, transparent)" }} />
          <DotGrid />
          {/* Ghost text */}
          <span className="absolute right-[4%] top-1/2 -translate-y-1/2 text-[140px] font-black text-white/[0.025] select-none leading-none hidden xl:block tracking-tighter">HI.</span>
        </div>
            ...
            >
              ...
              {submitted ? (
                ...
                >
                  ...
                  <button
                    onClick={() => { setSubmitted(false); setFormState({ name: "", email: "", budget: "", message: "" }); }}
                ...
                <form onSubmit={handleSubmit} className="relative z-10 flex flex-col gap-5">
                  <div>
                    <p className="text-white font-black text-2xl mb-1">Send a message</p>
                    <p className="text-gray-500 text-sm">Fill in the form and I&apos;ll be in touch shortly.</p>
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-xs font-semibold tracking-wide uppercase" style={{ color: "var(--color-accent-subtle)" }}>Budget range</label>
                    <select
                      ...
                      onBlur={(e) => e.target.style.borderColor = "rgba(255,255,255,0.08)"}
                    >
                      <option value="" style={{ backgroundColor: "#0e0e1a" }}>Select a range...</option>
                      <option value="under-1k" style={{ backgroundColor: "#0e0e1a" }}>Under £1,000</option>
                      <option value="1k-3k" style={{ backgroundColor: "#0e0e1a" }}>£1,000 – £3,000</option>
                      <option value="3k-7k" style={{ backgroundColor: "#0e0e1a" }}>£3,000 – £7,000</option>
                      <option value="7k-plus" style={{ backgroundColor: "#0e0e1a" }}>£7,000+</option>
                      <option value="not-sure" style={{ backgroundColor: "#0e0e1a" }}>Not sure yet</option>
                    </select>
                  </div>
            ...
            >
              {contactInfo.map((item, i) => (
                <div
                  ...
                  style={{ borderBottom: i < contactInfo.length - 1 ? "1px solid rgba(255,255,255,0.06)" : "none" }}
                >
                  <div
                  ...
                  <div>
                    <p className="text-gray-500 text-xs tracking-wide uppercase font-semibold mb-0.5">{item.label}</p>
                    {item.href ? (
                      <a href={item.href} className="text-white text-sm font-medium hover:underline" style={{ textDecorationColor: "var(--color-accent)" }}>
                        {item.value}
                      </a>
                    ) : (
      ...
      >
        <div className="absolute inset-0 pointer-events-none">
          <Glow style={{ width: 600, height: 300, top: 0, left: "30%", backgroundColor: "color-mix(in srgb, var(--color-accent-muted) 10%, transparent)" }} />
          <DotGrid />
        </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto grid lg:grid-cols-[280px_1fr] gap-16 items-start">
          <div>
            ...
            <p className="text-gray-500 text-sm leading-relaxed mt-4">
              ...
              <a href="mailto:hello@yourdomain.com" className="underline" style={{ color: "var(--color-accent-subtle)", textDecorationColor: "var(--color-accent-subtle)" }}>
                Just ask.
              </a>
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
            ...
            <motion.h2 variants={fadeUp} className="text-4xl md:text-6xl font-black text-white leading-tight mb-6">
              ...
              <br />
              starts with a{" "}
              <span className="text-accent-gradient">message</span>
            </motion.h2>
            <motion.p variants={fadeUp} className="text-gray-400 text-lg mb-10 max-w-md mx-auto leading-relaxed">
              No long forms. No waiting weeks for a reply. Just a conversation about what you need.
            </motion.p>
