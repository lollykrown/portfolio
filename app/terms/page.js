      ...
      <section className="py-16 px-6">
        ...
        >
          <Section title="1. Agreement to terms">
            <P>
              By accessing or using this website (lollykrown.com), you agree to
              be bound by these Terms of Service. If you do not agree to these
              terms, please do not use this website.
            </P>
            <P>
              These terms apply to all visitors, clients, and anyone who
              accesses or uses the website or our services.
            </P>
          </Section>

          <Section title="2. Services">
            <P>
              Lollykrown offers freelance web development, UI design, and
              photography services. Specific terms for client projects —
              including scope, deliverables, timeline, payment, and intellectual
              property — are set out in individual project agreements or
              proposals issued separately.
            </P>
            <P>
              Nothing on this website constitutes a binding offer to provide
              services. Engagement begins only when a written agreement or
          ...
          <Section title="3. Intellectual property">
            <P>
              ...
              design, code, photography, and graphics — is owned by Lollykrown
              or its licensors and is protected by UK and international
              copyright law.
            </P>
            <Ul
              items={[
                ...
                'Photography displayed on this website remains the intellectual property of Lollykrown unless explicitly transferred in a written agreement.',
              ]}
            />
          </Section>
          ...
          <Section title="4. Client work and project terms">
            <P>
              For commissioned projects, the following applies unless otherwise
              agreed in writing:
            </P>
            <Ul
              items={[
          ...
          <Section title="5. Photography licensing">
            <P>
              All photographs produced under commission are subject to the
              following unless a separate licence agreement is provided:
            </P>
            <Ul
              items={[
          ...
          <Section title="7. Disclaimer of warranties">
            <P>
              This website and its content are provided on an "as is" basis. We
              make no warranties, expressed or implied, including but not
              limited to:
            </P>
            <Ul
              items={[
          ...
          <Section title="8. Limitation of liability">
            <P>
              To the fullest extent permitted by law, Lollykrown shall not be
            ...
            <P>
              Our total liability to you in connection with any project or
              service shall not exceed the total fees paid by you to us in the
          ...
          <Section title="9. Third-party links">
            <P>
              ...
              the content or practices of third-party sites and accept no
              responsibility for them. Visiting linked sites is at your own
              risk.
            </P>
          </Section>
          ...
          <Section title="11. Changes to these terms">
            <P>
              ...
              updated" date will reflect the most recent revision. Continued use
              of this website after changes are posted constitutes acceptance of
              the updated terms.
            </P>
          </Section>
